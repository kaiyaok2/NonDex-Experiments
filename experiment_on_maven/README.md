...
This repository provides tools to identify Maven projects on GitHub and analyze them for ID flaky tests.
...
Run the `runNonDexMultipleProjects.sh` script to analyze the repositories listed in `repos.txt` and identify ID flaky tests.
